...
for popo= 1:length(order)
    ...
    x_rob_x = ceil((rob.pose(:,1)*1000 - MAP.xmin) ./ MAP.res);
    y_rob_x = ceil((rob.pose(:,2)*1000 - MAP.ymin) ./ MAP.res); 
    ...
    i
        ...
        if go_on==1
            ...
            [log_prob2, MAP]=updateMap2(log_prob2, new_cat_dist,x_rob_x(i),y_rob_x(i));
    ...
    %         bwwalls(walls)= 1; 
            ...
            if thetas(idx)~=0
                ...
                for j=1:length(ptd)
                    ...
                    x_rob_new = ceil((rob_new.pose(ptd(j),1)*1000 - MAP.xmin) ./ MAP.res);
                    y_rob_new = ceil((rob_new.pose(ptd(j),2)*1000 - MAP.ymin) ./ MAP.res); 
            ...
            elseif thetas(idx) ==0
                ...
                for j=ptd
                    ...
                    [log_prob2, MAP]=updateMap2(log_prob2, new_cat_dist,x_rob_x(j),y_rob_x(j));
                    clear new_cat_dist;
                end
            end
